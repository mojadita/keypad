...
pos_tab[] = {
	...
	{ 61, 0, 65, 15, "printscr", "Print-Scr", callback, },
	{ 65, 0, 69, 15, "scrolllock", "Scroll-lock", callback, },
	{ 69, 0, 73, 15, "pause", "Pause", callback, },
	...
	{ 69, 15, 73, 30, "pgup", "pg-up", callback, },

	{ 74, 15, 78, 30, "num", "", callback, },
	{ 78, 15, 82, 30, "kpslash", "7", callback, },
	{ 82, 15, 86, 30, "kpmult", "*", callback, },
	{ 86, 15, 90, 30, "kpdash", "-", callback, },
	...
	{ 69, 30, 73, 45, "pgdn", "pg-dn", callback, },

	{ 74, 30, 78, 45, "kp7", "kp-7", callback, },
	{ 78, 30, 82, 45, "kp8", "kp-8", callback, },
	{ 82, 30, 86, 45, "kp9", "kp-9", callback, },
	{ 86, 30, 90, 60, "kpplus", "kp-+", callback, },
 
	{ 0, 45, 7, 60, "caps", "caps-lock", callback, },
	...
	{ 74, 45, 78, 60, "kp4", "kp-4", callback, },
	{ 78, 45, 82, 60, "kp5", "kp-5", callback, },
	{ 82, 45, 86, 60, "kp6", "kp-6", callback, },
 
	{ 0,  60, 9, 75, "lshift", "left-shift", callback, },
	...
	{ 49, 60, 60, 75, "rshift", "right-shift", callback, },
 
	{ 65, 60, 69, 75, "up", "\033[A", callback, },
 
	{ 74, 60, 78, 75, "kp1", "kp-1", callback, },
	{ 78, 60, 82, 75, "kp2", "kp-2", callback, },
	{ 82, 60, 86, 75, "kp3", "kp-3", callback, },
	{ 86, 60, 90, 90, "kpenter", "kp-enter", callback, },
 
	{ 0,  75, 5, 90, "lctrl", "left-control", callback, },
	{ 5,  75, 10, 90, "win", "windows", callback, },
	{ 10,  75, 15, 90, "alt", "left-alt", callback, },
	{ 15, 75, 40, 90, "space", " ", callback, },
	{ 40, 75, 45, 90, "ralt", "right-alt", callback, },
	{ 45, 75, 50, 90, "f_n", "fn", callback, },
	{ 50, 75, 55, 90, "light", "light", callback, },
	{ 55, 75, 60, 90, "rctrl", "right-ctrl", callback, },
 
	{ 61, 75, 65, 90, "left", "\033[D", callback, },
	{ 65, 75, 69, 90, "up", "\033[B", callback, },
